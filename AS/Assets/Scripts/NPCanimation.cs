...
public class NPCanimation : MonoBehaviour
{
	...
	private Transform nPC;               // Reference to the player's transform.
	private NPCSight npcSight;          // Reference to the EnemySight script.
	...
	void Awake ()
	{
		...
		hash = GameObject.FindGameObjectWithTag(Tags.nPC).GetComponent<HashIDs>();
	...
	void NavAnimSetup ()
	{
		...
		if(npcSight.playerInSight)
		{
			...
			angle = FindAngle(transform.forward, nPC.position - transform.position, transform.up);
		}
		else
		{
